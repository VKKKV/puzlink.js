    ...
    expect(featuresOf("lefellele")).toMatchInlineSnapshot(`
      {
        ...
        "has at least 1 pair of equal letters, separated by 1 letter": "lEFEllele | e | 1 | f",
        "has at least 1 pair of equal letters, separated by 2 letters": "lefELLEle | e | 3 | ll",
        "has at least 1 pair of equal letters, separated by 3 letters": "LEFELlele | l | 0 | efe",
        ...
        "has at least 2 pairs of equal letters, separated by 1 letter": "lEfElLELE | efe | (lel) | (ele)",
        "has at least 2 pairs of equal letters, separated by 2 letters": "lefELlELe | elle | (llel)",
        ...
        "has at least 3 pairs of equal letters, separated by 1 letter": "lEfElLELE | efe | (lel) | (ele)",
